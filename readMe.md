The purpose of this application are to showcase the use of CRUD operations (Creating, Reading, Updating & Deleting data) for a patient management systemm with the theme of a hospital utilizing the MERN stack on Google Cloud . The system utilizes a combination of technologies to provide a robust and interactive user experience via React.js and is comprised of a navigation tool bar for navigation purposes, a home page to showcase the building and offered services, a page to create and record patient information, another page that will display information on a card component as to where the data for the patient information will then again be display with the option to update or delete the information.
